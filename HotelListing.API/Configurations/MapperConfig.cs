...
namespace HotelListing.API.Configurations
{
    public class MapperConfig : Profile //Inherit from 'Profile' - Remember to add using statement for Profile
    {
        ...
        public MapperConfig()
        {
            //Mapping-definitions are static, defined ONCE and reused throughout the lifetime of the application.

            //This constructor allows us to add "maps" into our data types.
            ...
            //          CreateMap<From, To>
            //  With this, you can "map" in either direction.
            //
            ...
            //IN GENERAL: You need to create a 'mapping' for EACH and EVERY new Dto!!!  
